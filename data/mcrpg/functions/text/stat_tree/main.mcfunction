...
data modify storage minecraft:mcrpg btn set value {}
...
execute unless score .y1 mcrpg matches 0 run data modify storage minecraft:mcrpg btn.up set value '{"text":"\\u2191","clickEvent":{"action":"run_command","value":"/trigger mcrpg_btn set 10001"}}'
execute if score .y1 mcrpg matches 0 run data modify storage minecraft:mcrpg btn.up set value '{"text":"\\u2191","color":"gray"}'


execute unless score .y2 mcrpg matches 45 run data modify storage minecraft:mcrpg btn.down set value '{"text":"\\u2193","clickEvent":{"action":"run_command","value":"/trigger mcrpg_btn set 10002"}}'
execute if score .y2 mcrpg matches 45 run data modify storage minecraft:mcrpg btn.down set value '{"text":"\\u2193","color":"gray"}'

data modify storage minecraft:mcrpg btn.right set value '{"text":"-\\u2192","color":"light_purple","clickEvent":{"action":"run_command","value":"/trigger mcrpg_btn set 10004"}}'

execute unless score .x1 mcrpg matches 0 run data modify storage minecraft:mcrpg btn.left set value '{"text":"\\u2190-","clickEvent":{"action":"run_command","value":"/trigger mcrpg_btn set 10003"}}'
execute if score .x1 mcrpg matches 0 run data modify storage minecraft:mcrpg btn.left set value '{"text":"\\u2190-","color":"gray"}'
