...
# left
execute if score @s mcrpg_btn matches 10002 run scoreboard players remove @s mcrpg_menu_x 1
# right 
execute if score @s mcrpg_btn matches 10002 run scoreboard players add @s mcrpg_menu_x 1
