...
# storage minecraft:mcrpg skills : copy of item skills object
# .skill_index index of skill 

# cycle skill index though skill array 
execute store result score .skill_count mcrpg run data get storage minecraft:mcrpg skills 
...
# modify item data 
data modify entity @e[type=armor_stand,tag=item_holder,limit=1] HandItems[0].tag.mcrpg.selectedSkill set from storage minecraft:mcrpg skill
