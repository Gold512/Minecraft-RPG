...
title @s actionbar ["", {"text":"","extra":["",{"nbt":"skill.displayName","storage":"mcrpg", "interpret": true}, " ", {"storage":"mcrpg","nbt":"skill.mana", "color":"dark_aqua", "extra":["\u2741"]}, " ",{"storage":"mcrpg","nbt":"attack_text","interpret": true}, {"storage":"mcrpg", "nbt":"skill.ct", "color":"green", "extra":["\u231B"]}]}, {"text":" | ", "color": "gray"} , {"nbt":"color","storage":"mcrpg", "interpret": true, "extra":[{"score":{"name":"@s","objective": "mcrpg_mana"}}]}, {"text":"/","color":"dark_aqua"}, {"score":{"name":"@s","objective": "mcrpg_maxMana"},"color":"dark_aqua"}, {"text":"\u2741","color":"dark_aqua"}, {"text":" [", "color":"gray"}, {"text":"+","color":"aqua"}, {"score":{"name":"@s","objective": "mcrpg_manaRegen"}, "color":"aqua"}, {"text":"]", "color":"gray"}]